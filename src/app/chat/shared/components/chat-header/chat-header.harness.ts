...
export class ChatHeaderHarness extends ComponentHarness {
    ...
    getBackButton = this.locatorFor('#chat_header_back_button');
    getCloseButton = this.locatorFor('#chat_header_close_button');
    getTitle = this.locatorFor('.chat-title');
    getSettingsButton = this.locatorFor('#chat_header_settings_button');
