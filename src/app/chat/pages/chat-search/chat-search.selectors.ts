...
export const chatSearchSelectors = createChildSelectors(chatFeature.selectSearch, initialState)

export const selectResults = createSelector(chatSearchSelectors.selectResults, (results): RowListGridData[] => {
...
export const selectChatSearchViewModel = createSelector(
  ...
  (columns, searchCriteria, results, displayedColumns, viewMode, chartVisible): ChatSearchViewModel => ({
    columns,
    searchCriteria,
    results,
    displayedColumns,
