...
// @ts-ignore
import { ChatMessageSearchCriteria } from '../model/chatMessageSearchCriteria';
// @ts-ignore
...
export class ChatsService {
     ...
     * @param chatMessageSearchCriteria 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public searchChatMessages(chatMessageSearchCriteria: ChatMessageSearchCriteria, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<ChatMessageResponse>;
    public searchChatMessages(chatMessageSearchCriteria: ChatMessageSearchCriteria, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<ChatMessageResponse>>;
    public searchChatMessages(chatMessageSearchCriteria: ChatMessageSearchCriteria, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<ChatMessageResponse>>;
    public searchChatMessages(chatMessageSearchCriteria: ChatMessageSearchCriteria, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (chatMessageSearchCriteria === null || chatMessageSearchCriteria === undefined) {
            throw new Error('Required parameter chatMessageSearchCriteria was null or undefined when calling searchChatMessages.');
        }
        ...
        let localVarPath = `/chats/messages/search`;
        return this.httpClient.request<ChatMessageResponse>('post', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                body: chatMessageSearchCriteria,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
                headers: localVarHeaders,
                observe: observe,
